...
df_input_movies = pd.read_csv('https://raw.githubusercontent.com/BerengerQueune/ABC-Data/main/Berenger/Database_projet/df_input_aurore.csv?token=AU6BUZQEKD6TE7Y5H3CTAHTBT6ICO')
